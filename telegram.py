...
while True:
	...
	텔레그램 = image_lib.capture_click(hwnd, ".\\coin_img\\tel.jpg",0.98)
	if 싸움탭:
		매크로종료 = image_lib.match_img(hwnd, ".\\coin_img\\macro_stop.jpg")
		if 매크로종료:
			image_lib.mouse_click(hwnd, 매크로종료[0], 매크로종료[1]-20)
			time.sleep(1)
			image_lib.mouse_click(hwnd, 텔레그램[0], 텔레그램[1])

	텔레그램채팅 = image_lib.capture_click(hwnd, ".\\coin_img\\tel_chat.jpg",0.98)
	if 싸움탭:
		매크로종료 = image_lib.match_img(hwnd, ".\\coin_img\\macro_stop.jpg")
		if 매크로종료:
			image_lib.mouse_click(hwnd, 매크로종료[0], 매크로종료[1]-20)
	...
	텔레그램채팅2 = image_lib.capture_click(hwnd, ".\\coin_img\\tel_chat2.jpg",0.98)
	if 싸움탭:
		매크로종료 = image_lib.match_img(hwnd, ".\\coin_img\\macro_stop.jpg")
		if 매크로종료:
			image_lib.mouse_click(hwnd, 매크로종료[0], 매크로종료[1]-20)
